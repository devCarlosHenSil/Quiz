...
export default function GameScreen() {
  ...
  React.useEffect(() => {
    if(isLastQuestion) {
      ...
      // A Pegar o nome do usuário definido na tela anterior e mostrar na tela final
      ...
      <section className={pageStyles.container}>
        ...
        >
          ...
          <form
            ...
            onSubmit={(event) => {
              // A Fazer Quebrar o onSubmit em funções menores
...
// A Criar um componente genérico que representa nossa tela
// A Criar a tela de resultados quando tiverem "acabado" as questões